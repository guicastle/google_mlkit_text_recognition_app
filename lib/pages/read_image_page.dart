...
class ReadImagePage extends StatefulWidget {
  const ReadImagePage({super.key});

  @override
  State<ReadImagePage> createState() => _ReadImagePageState();
}

class _ReadImagePageState extends State<ReadImagePage> {
  String title = '';
  String total = '';
